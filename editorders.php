                                        ...
                                        <div class="col-lg-6">
                                            <form role="form" action="<?php echo $postOrderAddress; ?>" method="POST">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="checkbox">
                                                        <label>
                                                            <input name="Is_Paid_new" type="checkbox"  <?php if($data->Is_Paid==1){echo "checked" ;}?> value="1">האם שולם
                                                        </label>
                                                    </div>
                                                    <div class="checkbox">
                                                        <label>
                                                            <input name="Is_Delivered_new" <?php if($data->Is_Delivered==1){echo "checked" ;}?> type="checkbox" value="1">האם  נשלח
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="form-group">
